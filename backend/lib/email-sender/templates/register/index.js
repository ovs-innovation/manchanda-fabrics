    ...
    <div style="background-color:#f2f3f8; padding-bottom:100px;">
                                      ...
                                      <tr>
                                        <td style="width:150px;">
                                          ...
                                          <img
                                            alt
                                            height="auto"
                                            src="${option.logo || "https://res.cloudinary.com/dse9adftu/image/upload/v1780479335/manchanda/brand/logo.png"}"
      ...
      >
        ...
        <p style="margin-bottom:20px;">Click this link for active your account</p></p>
                             ...
                             <a href="${process.env.STORE_URL || process.env.FRONTEND_URL || "https://Manchanda Fabrics.com"}/auth/email-verification/${option.token}" style="background:#22c55e;color:white;border:1px solid #22c55e; padding: 10px 15px; border-radius: 4px; text-decoration:none;">Verify Account</a>
