const attributes = [
  {
    ...
    variants: [
      {
        status: "show",
        _id: "manchanda-color-black",
        name: { en: "Black" },
        hexColor: "#000000",
      },
      {
        status: "show",
        _id: "manchanda-color-white",
        name: { en: "White" },
        hexColor: "#FFFFFF",
      },
      {
        status: "show",
        _id: "manchanda-color-blue",
        name: { en: "Blue" },
        hexColor: "#2563EB",
      },
      {
        status: "show",
        _id: "manchanda-color-red",
        name: { en: "Red" },
        hexColor: "#DC2626",
      },
      {
        status: "show",
        _id: "manchanda-color-green",
        name: { en: "Green" },
        hexColor: "#16A34A",
      },
      {
        status: "show",
        _id: "manchanda-color-brown",
        name: { en: "Brown" },
        hexColor: "#92400E",
      },
      {
        status: "show",
        _id: "manchanda-color-pink",
        name: { en: "Pink" },
        hexColor: "#EC4899",
      },
      {
        status: "show",
        _id: "manchanda-color-grey",
        name: { en: "Grey" },
        hexColor: "#6B7280",
      },
    ],
