const setting = [
  {
    setting: {
      ...
      website: "Manchanda Fabrics.com",
      default_currency: "₹",
      default_time_zone: "Asia/Kolkata",
      default_date_format: "MMM D, YYYY",
      receipt_size: "57-mm",
      from_email: "info@Manchanda Fabrics.com",
    ...
    setting: {
      ...
      home: {
        ...
        quick_delivery_description: {
          en: "There are many products you will find in our shop, Choose your daily necessary product from our manchanda shop and get some special offers. See Our latest discounted products from here and get a special discount.",
          de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem manchanda shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
        },
        ...
        daily_need_title: {
          en: "Get Your Daily Needs From Our Manchanda Fabrics",
          de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
        },
        daily_need_description: {
          en: "There are many products you will find in our shop, Choose your daily necessary product from our manchanda shop and get some special offers.",
          de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem manchanda shop und erhalten Sie einige Sonderangebote.",
        },
      ...
      about_us: {
        ...
        top_title: {
          en: "Welcome to our manchanda shop",
          de: "Willkommen in unserem manchanda shop",
        },
        top_description: {
      ...
      faq: {
        ...
        faq_one: {
          en: "How does the Manchanda Fabrics work?",
          de: "Wie funktioniert der Manchanda Fabrics?",
        },
        description_one: {
        ...
        faq_five: {
          en: "What is Manchanda Fabrics EC2 auto scaling?",
          de: "Was ist die automatische Skalierung von Manchanda Fabrics EC2?",
        },
        description_five: {
          en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
        ...
        faq_six: {
          en: "What are the benefits of using Manchanda Fabrics affliate?",
      ...
      slider: {
        ...
        second_title: {
          en: "Best Different Type of Manchanda Fabrics",
