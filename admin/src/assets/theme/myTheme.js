const myTheme = {
  ...
  alert: {
    ...
    withClose: "pr-12",
    success: "bg-store-50 text-store-900 dark:bg-store-600 dark:text-white",
    ...
    icon: {
      base: "h-5 w-5",
      success: "text-store-400 dark:text-store-300",
  ...
  badge: {
    ...
    success: "text-store-600 bg-store-100 dark:bg-store-800 dark:text-store-100",
  ...
  textarea: {
    ...
    valid:
      "border-store-600 dark:bg-gray-700 focus:border-store-400 dark:focus:border-store-400",
    invalid:
  ...
  input: {
    ...
    invalid:
      "border-red-600 dark:bg-gray-700 focus:border-red-400 dark:focus:border-red-400",
    radio: "text-store-600 form-radio focus:border-store-400 focus:outline-none",
    checkbox:
      "text-store-600 form-checkbox focus:border-store-500 focus:outline-none rounded",
  },
  // HelperText
  helperText: {
    base: "text-xs",
    valid: "text-store-600 dark:text-store-400",
  ...
  button: {
    ...
    primary: {
      base: "text-white bg-store-500 border border-transparent",
      active: "active:bg-store-600 hover:bg-store-600",
      disabled: "opacity-50 cursor-not-allowed",
    },
    modern: {
