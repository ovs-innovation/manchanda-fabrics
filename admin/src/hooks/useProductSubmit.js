  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const productData = {
        ...
        prices: {
          price: Number(getNumberTwo(data.salePrice)) || Number(getNumberTwo(data.price)) || Number(getNumberTwo(data.originalPrice)),
          originalPrice: Number(getNumberTwo(data.originalPrice)),
          salePrice: data.salePrice ? Number(getNumberTwo(data.salePrice)) : 0,
          discount: Math.max(0, Number(getNumberTwo(data.originalPrice)) - (Number(getNumberTwo(data.salePrice)) || Number(getNumberTwo(data.price)) || Number(getNumberTwo(data.originalPrice)))),
          discountType: "flat",
        },
