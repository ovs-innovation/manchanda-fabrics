...
const TESTIMONIALS = [
  {
    ...
    item: "Embroidered Festive Suit Set",
    rating: 5,
    comment: "Absolutely stunning suit set. The silk blend and zari dupatta are top-notch. It was the highlight of our family gathering. Highly recommend Manchanda Fabrics for authentic ethnic suits.",
  ...
  },
  {
    ...
    name: "Priya Sen",
    role: "Boutique Owner",
    item: "Cotton Straight Suit Fabric",
    rating: 5,
    comment: "The unstitched suit fabrics here are exceptional. Pure cotton with beautiful prints — perfect for tailoring salwar kameez sets for my boutique clients.",
