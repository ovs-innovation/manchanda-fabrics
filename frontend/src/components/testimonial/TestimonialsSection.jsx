...
const TestimonialsSection = () => {
  ...
  const fallbackReviews = [
    {
      _id: "fb1",
      title: "STUNNING ANARKALI SET",
      text: "The embroidery on this festive suit set is exquisite — just like Biba's wedding edit. Rich fabric, perfect fit, and the dupatta drapes beautifully. Manchanda Fabrics is my go-to for ethnic suits.",
      author: "Priya S.",
      role: "Verified Buyer",
    ...
    },
    {
      ...
      text: "Soft handblock cotton straight suit — breathable and elegant for office and everyday wear. The pastel palette and clean stitching feel premium. Already ordered two more sets!",
      author: "Ananya M.",
    ...
    {
      _id: "fb3",
      title: "WEDDING SUIT COLLECTION",
      text: "Ordered a Bangalori silk suit set for my sister's reception. The zari work and border detailing are authentic and luxurious. Delivered on time with beautiful packaging.",
      author: "Meera K.",
