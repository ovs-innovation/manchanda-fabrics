...
const WomenCollection = ({ products, attributes }) => {
  ...
  return (
    <Layout
      title={t("Women Collection")}
      description={t("Discover Manchanda Fabrics premium Women's collection - clothing, footwear, and accessories.")}
    >
        ...
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-8">
          ...
          {products?.length === 0 ? (
            <div className="text-center py-20 text-gray-400 font-bold uppercase tracking-wider">
              {t("No items available in this collection.")}
            </div>
          ) : (
