...
const RefundReturnPolicy = () => {
  ...
  return (
    <Layout title="Refund & Return Policy" description="This is refund and return policy page">
      {/* Premium Header */}
      <div className="bg-[#FAF7F5] py-16 lg:py-24 border-b border-[#E6D1CB]/60">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-10 text-center">
          <h1 className="text-4xl md:text-5xl font-serif font-black text-[#3B2A25] mb-6 uppercase tracking-tight flex items-center justify-center gap-3">
          ...
          <p className="text-[#3B2A25]/70 text-lg md:text-xl max-w-3xl mx-auto">
      ...
      <div className="bg-black min-h-screen px-4 sm:px-10 py-12 lg:py-20">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Main Policy Box */}
          <div className="bg-[#FAF7F5] rounded-3xl border border-[#E6D1CB]/60 overflow-hidden text-justify shadow-2xl">
            ...
            <div className="p-6 md:p-10 lg:p-12">
              ...
              <div className="refund-policy-content">
                <div className="text-[#3B2A25]/85 leading-relaxed font-sans">
                  <CMSkeleton
                    html
                    count={15}
                    height={15}
...
<p>You may cancel your order at no cost before it has been dispatched. Dispatched orders cannot be cancelled.</p>`}
          ...
          {!loading && !error && (
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-5 font-sans">
              ...
              {/* Card 1 - Easy Returns */}
              <div className="bg-white border border-[#E6D1CB]/60 rounded-xl p-5 hover:border-[#E6D1CB]/60 transition-all shadow-md">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-neutral-950 border border-[#E6D1CB]/60 rounded-lg flex items-center justify-center flex-shrink-0">
                    <FiPackage className="w-5 h-5 text-[#9C6A5A]" />
                  </div>
                  <div>
                    <h3 className="text-base font-serif font-bold uppercase tracking-wider text-[#3B2A25] mb-2">Easy Returns</h3>
                    <p className="text-sm text-[#3B2A25]/70 leading-relaxed">
              ...
              <div className="bg-white border border-[#E6D1CB]/60 rounded-xl p-5 hover:border-[#E6D1CB]/60 transition-all shadow-md">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-neutral-950 border border-[#E6D1CB]/60 rounded-lg flex items-center justify-center flex-shrink-0">
                    <FiRefreshCw className="w-5 h-5 text-[#9C6A5A]" />
                  </div>
                  <div>
                    <h3 className="text-base font-serif font-bold uppercase tracking-wider text-[#3B2A25] mb-2">Quick Refunds</h3>
                    <p className="text-sm text-[#3B2A25]/70 leading-relaxed">
              ...
              <div className="bg-white border border-[#E6D1CB]/60 rounded-xl p-5 hover:border-[#E6D1CB]/60 transition-all shadow-md">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-neutral-950 border border-[#E6D1CB]/60 rounded-lg flex items-center justify-center flex-shrink-0">
                    <FiCalendar className="w-5 h-5 text-[#9C6A5A]" />
                  </div>
                  <div>
                    <h3 className="text-base font-serif font-bold uppercase tracking-wider text-[#3B2A25] mb-2">Return Window</h3>
                    <p className="text-sm text-[#3B2A25]/70 leading-relaxed">
              ...
              <div className="bg-white border border-[#E6D1CB]/60 rounded-xl p-5 hover:border-[#E6D1CB]/60 transition-all shadow-md">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-neutral-950 border border-[#E6D1CB]/60 rounded-lg flex items-center justify-center flex-shrink-0">
                    <FiShield className="w-5 h-5 text-[#9C6A5A]" />
                  </div>
                  <div>
                    <h3 className="text-base font-serif font-bold uppercase tracking-wider text-[#3B2A25] mb-2">Quality Assurance</h3>
                    <p className="text-sm text-[#3B2A25]/70 leading-relaxed">
          ...
          {!loading && !error && (
            <div className="mt-8 font-sans">
              <div className="bg-gradient-to-r from-neutral-950 to-neutral-900 rounded-xl border border-[#E6D1CB]/50 p-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-neutral-950 border border-[#E6D1CB]/60 rounded-xl shadow-sm flex items-center justify-center flex-shrink-0">
                    <FiHeadphones className="w-6 h-6 text-[#9C6A5A]" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg font-serif font-bold uppercase tracking-wider text-[#3B2A25] mb-2">Need Help with Returns?</h3>
                    <p className="text-sm text-[#3B2A25]/70 mb-4">
                      If you have any questions about our refund and return policy, please contact our customer support team.
                    </p>
                    <div className="flex flex-wrap items-center gap-4">
                      <div className="flex items-center gap-2 text-sm text-[#9C6A5A] bg-black border border-[#E6D1CB]/60 px-4 py-2 rounded-lg">
